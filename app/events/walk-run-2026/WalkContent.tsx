...
const CONFIRMED_CITIES = [
  { city: "Atlanta", state: "GA", date: "Sat, May 30", venue: "", beneficiary: "" },
  { city: "Boston", state: "MA", date: "Sat, May 30", venue: "", beneficiary: "" },
  { city: "Chicago", state: "IL", date: "Sat, May 30", venue: "", beneficiary: "" },
  { city: "Los Angeles", state: "CA", date: "Sat, May 30", venue: "", beneficiary: "" },
  { city: "Philadelphia", state: "PA", date: "Sat, May 30", venue: "", beneficiary: "" },
  { city: "Roanoke", state: "VA", date: "Sat, May 30 · 9:00 AM", venue: "Elmwood Park Amphitheater", beneficiary: "Carilion Clinic Foundation" },
  { city: "San Francisco", state: "CA", date: "Sat, May 30", venue: "", beneficiary: "" },
  { city: "West Chicago", state: "IL", date: "Sat, May 30", venue: "McCaslin Park, 27W650 North Ave", beneficiary: "People's Resource Center" },
  { city: "Boca Raton", state: "FL", date: "Sat, May 31", venue: "Mary Lou Berger Pavilion, South County Regional Park", beneficiary: "" },
  { city: "Irving (Dallas)", state: "TX", date: "Sun, May 31 · 8:00 AM", venue: "Levy Event Plaza, 501 E Las Colinas Blvd", beneficiary: "Children's Health" },
  { city: "Miami", state: "FL", date: "Sat, May 31", venue: "", beneficiary: "" },
  { city: "New York City", state: "NY", date: "Sun, May 31", venue: "", beneficiary: "" },
  { city: "Sacramento", state: "CA", date: "Sat, Jun 6 · 9:00 AM", venue: "Stone Creek Community Park, Rancho Cordova", beneficiary: "" },
];
...
const FAQS = [
  { q: "Why are you doing the Walk?", a: "The BAPS Charities Walk brings our community together for a greater purpose. It promotes health, unity, and selfless service while raising awareness about the positive impact we make locally and nationally." },
  { q: "Who can participate?", a: "Anyone can join — it's open to the community." },
  { q: "Where does the money go?", a: "Fundraising efforts support community initiatives by BAPS Charities and local beneficiaries in your city." },
  { q: "How many walkers are expected?", a: "Close to 50,000 walkers across North America." },
  { q: "What's unique about your walk?", a: "The BAPS Charities Walk is fully volunteer-driven. Thousands of volunteers organize and manage the event across cities in North America." },
  { q: "What is the registration fee?", a: "$15 per person for individuals or teams." },
...
export default function WalkContent({ registrationUrl = FALLBACK_REGISTRATION_URL }: WalkContentProps = {}) {
  ...
  return (
    <>
          ...
          <aside style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ background: "#faf7f3", border: "1px solid #E4DFDA", borderRadius: 4, padding: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <a href="https://baps.sl/walk-pressrelease" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: "#8E191D", textDecoration: "none", fontWeight: 600 }}>Download press release &rarr;</a>
                <a href="https://baps.sl/walk-photo-video-guide" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: "#8E191D", textDecoration: "none", fontWeight: 600 }}>Photo &amp; video guide &rarr;</a>
      ...
      {tab === "faq" && (
        <div style={{ maxWidth: 800 }}>
          ...
          <div style={{ marginTop: 40, padding: 28, background: "#fff", border: "1px solid #E4DFDA", borderRadius: 4 }}>
            <div style={{ fontSize: 14, color: "#4C4238" }}>
      ...
      <div style={{ marginTop: 48, padding: "28px 0 0", borderTop: "1px solid #E4DFDA" }}>
        <Link href="/events/walk-run-2026" style={{ fontSize: 13, color: "#7a716a", textDecoration: "none" }}>
          &larr; Back to Walk | Run 2026
        </Link>
      </div>
    </>
  );
